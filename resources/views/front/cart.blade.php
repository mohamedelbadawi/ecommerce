                        ...
                        <table class="table text-nowrap">
                            ...
                            @foreach(Cart::content() as $product)
                                ...
                                <tr>
                                    <th class="ps-0 py-3 border-light" scope="row">
                                        <div class="d-flex align-items-center"><a
                                            ...
                                            <div class="ms-3"><strong class="h6"><a class="reset-anchor animsition-link"
                                                                                    href="detail.blade.php">{{$product->name}}</a></strong></div>
                                        </div>
                                    </th>
                                    ...
                                    <td class="p-3 align-middle border-light">
                                        <p class="mb-0 small"> {{$product->total}} $</p>
                                    </td>
                    ...
                    <div class="bg-light px-4 py-3">
                        <div class="row align-items-center text-center">
                            <div class="col-md-6 mb-3 mb-md-0 text-md-start"><a
                                    class="btn btn-link p-0 text-dark btn-sm" href="{{route('home')}}"><i
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mb-0">
                                ...
                                <li class="d-flex align-items-center justify-content-between mb-4"><strong
                                        class="text-uppercase small font-weight-bold">Total</strong><span>{{\Cart::total()}}</span>
                                </li>
                                <li>
                                    <form action="#">
