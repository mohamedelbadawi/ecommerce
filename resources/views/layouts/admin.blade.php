            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="{{route('admin.edit_settings')}}" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<script src="{{ asset('vendor/file input/js/plugins/piexif.min.js') }}"></script>
<script src="{{ asset('vendor/file input/js/plugins/sortable.min.js') }}"></script>
<script src="{{ asset('vendor/file input/js/fileinput.min.js') }}"></script>
<script src="{{ asset('vendor/file input/themes/fas/theme.min.js') }}"></script>
