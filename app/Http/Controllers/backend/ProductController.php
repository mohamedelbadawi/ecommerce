...
class ProductController extends Controller
{
    ...
    public function editAttribute(Product $product, ProductAttribute $productAttribute)
    {
        ...
        return view('admin.product.attributes.edit', compact('productAttribute', 'product', 'colors', 'sizes'));
    }
    ...
    public function createAttribute(Product $product)
    {
        ...
        return view('admin.product.attributes.create', compact('product', 'sizes', 'colors'));
    }
